...
JSMpeg.Source.AjaxProgressive = function() {
    ...
    ;
    AjaxProgressiveSource.prototype.start = function( fileSize ) {
        this.request = new XMLHttpRequest;
        this.request.onreadystatechange = function() {
            if (this.request.readyState === this.request.DONE) {
                this.fileSize = parseInt(this.request.getResponseHeader("Content-Length")) || fileSize;
                this.loadNextChunk()
            }
        }
        .bind(this);
    ...
    AjaxProgressiveSource.prototype.resume = function(secondsHeadroom) {
        ...
        var worstCaseLoadingTime = this.loadTime * 8 + 2 + 5;
